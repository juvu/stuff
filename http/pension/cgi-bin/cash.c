...
*/	
	...
	else
	{
		...
		for (loop=0;loop<nextYear-1;loop++)
		{
			...
			printf ("<TD><center>%d<center>\n", (int) (years[rs][loop].ZRP * inflationFactor + 0.5)) ;
			printf ("<TD><center>%d<center>\n", (int)(years[rs][loop].Zurich * inflationFactor + 0.5)) ;
			printf ("<TD><center>%d<center>\n", (int)(years[rs][loop].Pru * inflationFactor + 0.5)) ;
			printf ("<TD><center>%.2f<center>\n", (years[rs][loop].investmentReturn)) ;
			printf ("<TD><center>%d<center>\n", (int)(years[rs][loop].cash * inflationFactor + 0.5)) ;
			printf ("<TD><center>%.2f<center>\n", (years[rs][loop].cashReturn)) ;
			printf ("<TD><center>%.2f<center>\n", years[rs][loop].inflation) ;
			printf ("<TD><center>%d<center>\n", (int)(years[rs][loop].ZRPIncome * inflationFactor + 0.5)) ;
			printf ("<TD><center>%d<center>\n", (int)(years[rs][loop].ZurichIncome * inflationFactor + 0.5)) ;
			printf ("<TD><center>%d<center>\n", (int)(years[rs][loop].PruIncome * inflationFactor + 0.5)) ;
			printf ("<TD><center>%d<center>\n", (int)(years[rs][loop].cashIncome * inflationFactor + 0.5)) ;
			printf ("<TD><center>%d<center>\n", (int)(years[rs][loop].rentIncome * inflationFactor + 0.5)) ;
			printf ("<TD><center>%d<center>\n", (int)(years[rs][loop].stateIncome * inflationFactor + 0.5)) ;
			printf ("<TD><center>%d<center>\n", (int)(years[rs][loop].FerrantiIncome * inflationFactor + 0.5)) ;
			printf ("<TD><center>%d<center>\n", (int)(years[rs][loop].SimonIncome * inflationFactor + 0.5)) ;
			printf ("<TD><center>%d<center>\n", (int)(years[rs][loop].Spend * inflationFactor + 0.5)) ;
			printf ("<TD><center>%d<center>\n", (int)(years[rs][loop].TaxAllowance * inflationFactor + 0.5)) ;
			printf ("<TD><center>%d<center>\n", (int)(years[rs][loop].tax * inflationFactor + 0.5)) ;
			printf ("<TD><center>%d<center>\n", (int)(years[rs][loop].total * inflationFactor + 0.5)) ;
			printf ("<TD><center>%d<center>\n", (int)(years[rs][loop].inheritance * inflationFactor + 0.5)) ;
			printf ("<TD><center>%d<center>\n", (int)(years[rs][loop].income * inflationFactor + 0.5)) ;
			...
			printf ("<TD><center>%d<center>\n", (int)((years[rs][loop].cashSpend) * inflationFactor + 0.5)) ;
